...
BLOG_AUTHOR = "Andrew"  # (translatable)
BLOG_TITLE = "44digits"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://44digits.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://44digits.com/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "Spatial data engineering"  # (translatable)
...
BODY_END = """
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-E442ZFNPV9"></script>
<script>
